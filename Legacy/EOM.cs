...
public static class OldEOM
{
    //-----------------------------------------------------
    // calculates the forces associated with an aircraft
    // given a set of properties and current state
    //-----------------------------------------------------
    public static void plane_rhs(Properties prop, PlayerState state, float[] q, float[] delta_q, float dt, float q_scale, ref float[] dq)
    {
        // Gravity
        float G = -9.81f;
    ...
    // integration method
    //-----------------------------------------------------
    public static void eom(Properties prop, ref PlayerState state, float dt)
    {
